...
<?php
    ...
    $this_page_first_result = ($page-1)*$results_per_page;
      ...
      if( isset( $_POST['search'] ) ) { 
        ...
        $sql = "SELECT * FROM scholarships WHERE CONCAT(`scholar_id`, `title`, `discription`, `cdate`) LIKE  '%".$searchKey."%'";
       
        
    } else {
        $sql='SELECT * FROM scholarships LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
        $searchKey = "search";
    }
...
.form-control:focus {
    ...
    <div class="student_body">
			...
			<div class="col-sm-12">
                ...
                <div class="col-sm-9 float-right mt-4 " >
                    <div class="col-sm-3 float-right" data-toggle="modal" data-target="#exampleModal">
                        ...
                        <h4 style="margin-left:10px;">Add Scholarships</h4>
                    </div>
                    <div class="col-sm-12 float-left pt-4 pb-5" style="box-shadow: -4px -13px 18px -13px rgba(0,0,0,0.5); background-color:white;" >
                        ...
                        <div   class=" col-sm-12 float-right pt-5  " style="overflow-y: auto;">
							...
							?>
                                ...
                                <tr>
                                    <td style="display:none;"><?php echo $rows->scholar_id; ?></td>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="validatescholar.php" method="POST">
                        <div class="form-group">
                            <label for="stitle"> Title</label>
                            <input name="title" type="text" class="form-control" id="stitle" placeholder="" required>
                        </div>
                        <div class="form-group">
                            <label for="discription"> Title</label>
                            <textarea name="discription" type="text" class="form-control" id="discription" placeholder="" ></textarea>
                        </div>

                        <button type="submit" class="btn btn-success btn-sm float-right" name="add_scholar">Add Post</button>
                    </form>
                </div>
    ...
    <div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel"> Edit Scholarships </h5>
				        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
				          <span aria-hidden="true">&times;</span>
				        </button>
				      </div>

				        <form action="updatescholar.php" method="POST">

				            <div class="modal-body">
                                <input type="hidden" name="scholar_id" id="scholarid">
                                <div class="form-group">
                                    <label for="s_title"> Title</label>
                                    <input name="title" type="text" class="form-control" id="s_title" placeholder="" >
                                </div>
                                <div class="form-group">
                                    <label for="s_discription"> Discrition</label>
                                    <input name="discription" type="text" class="form-control" id="s_discription" placeholder="" >
                                </div>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        ...
					        <form action="deletescholar.php" method="POST">
...
$(document).ready(function () {
    $('.editbtn').on('click', function() {
            ...
            $('#scholarid').val(data[0]);
            $('#s_title').val(data[1]);
            $('#s_discription').val(data[2]);
