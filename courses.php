...
<?php
    ...
    $this_page_first_result = ($page-1)*$results_per_page;
      ...
      if( isset( $_POST['search'] ) ) { 
        ...
        $sql = "SELECT * FROM courses WHERE CONCAT(`c_name`, `degree`, `pinid`) LIKE  '%".$searchKey."%'";
       
        
    } else {
        $sql='SELECT * FROM courses LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
        $searchKey = "search";
    }
			...
			<div class="col-sm-12">
                ...
                <div class="col-sm-9 float-right mt-4 " >
                    <div class="col-sm-3 float-right" data-toggle="modal" data-target="#exampleModal">
                        ...
                        <h4 style="margin-left:10px;">Add Courses</h4>
                    </div>
                       ...
                       <form action="" method="POST">
                        ...
                        <div   class=" col-sm-12 float-right pt-5  " style="overflow-y: auto;">
							...
							?>
                                ...
                                <tr>
                                    <td style="display:none;"><?php echo $rows->cid; ?></td>
                                    <td><?php echo $rows->c_name; ?></td>
						            <td><?php echo $rows->degree; ?></td>
						            <td><?php echo $rows->pinid; ?></td>
                                    <!--  dropdown button -->
                                    <td>
                                        <div class=" dropleft">
                            ...
                            <nav aria-label="Page navigation example" class="float-right" >
                                <ul class="pagination" >
                                    <?php
                                        echo '<li class="page-item"><a style="color:#15910d;" class="page-link"  href="courses.php?page=' . $prev . '">' . 'Previous' . '</a> '; 

                                    ?>
                                    
                                    <?php
                                        for ($page=1;$page<=$number_of_pages;$page++) {
                                            echo '<li class="page-item"><a style="color:#15910d;" class="page-link"  href="courses.php?page=' . $page . '">' . $page . '</a> ';
                                        }
                                    ?>
                                    <?php
                                        echo '<li class="page-item"><a style="color:#15910d;" class="page-link"  href="courses.php?page=' . $next . '">' . 'Next' . '</a> '; 
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="validate_course.php" method="POST">
                        <div class="form-group">
                            <label for="c_name">Course Name</label>
                            <input name="c_name" type="text" class="form-control" id="c_name" placeholder="Math" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name ="degree" type="text" class="form-control" id="degree" placeholder="CSE" required>
                        </div>

                        <div class="form-group">
                            <label for="c_pinid">PIN ID</label>
                            <input type="text" name="c_pinid" class="form-control" id="c_pinid" placeholder="12345">
                        </div>

                        <button type="submit" class="btn btn-success btn-sm float-right" name="add_course"> Add Course </button>
                    </form>
                </div>
				        ...
				        <form action="updateCourse.php" method="POST">
				            ...
				            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="course_name" type="text" class="form-control" id="course_name" placeholder="Math" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name ="deg" type="text" class="form-control" id="deg" placeholder="CSE" required>
                                </div>

                                <div class="form-group">
                                    <label for="cpin_id">PIN ID</label>
                                    <input type="text" name="cpin_id" class="form-control" id="cpin_id" placeholder="12345">
                                </div>
