...
<?php
    ...
    $this_page_first_result = ($page-1)*$results_per_page;
      ...
      if( isset( $_POST['search'] ) ) { 
        ...
        $sql = "SELECT * FROM internship WHERE CONCAT(`intern_id`, `intern_title`, `discription`, `type`, `intern_date`) LIKE  '%".$searchKey."%'";
       
        
    } else {
        $sql='SELECT * FROM internship LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
        $searchKey = "search";
    }
    ...
    <div class="student_body">
			...
			<div class="col-sm-12">
                ...
                <div class="col-sm-9 float-right mt-4 " >
                    <div class="col-sm-3 float-right" data-toggle="modal" data-target="#exampleModal">
                        ...
                        <h4 style="margin-left:10px;">Add Internships</h4>
                    </div>
                    <div class="col-sm-12 float-left pt-4 pb-5" style="box-shadow: -4px -13px 18px -13px rgba(0,0,0,0.5); background-color:white;" >
                        ...
                        <div   class=" col-sm-12 float-right pt-5  " style="overflow-y: auto;">
							...
							?>
                                ...
                                <tr>
                                    <td style="display:none;"><?php echo $rows->intern_id; ?></td>
                                    <td><?php echo $rows->intern_title; ?></td>
						            <td><?php echo $rows->discription; ?></td>
						            <td><?php echo $rows->intern_date; ?></td>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form action="validateintern.php" method="POST">
                        <div class="form-group">
                            <label for="intern_title"> Title</label>
                            <input name="intern_title" type="text" class="form-control" id="intern_title" placeholder="" required>
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn btn-success btn-sm float-right" name="add_intern">Add Post</button>
                    </form>
                </div>
				        ...
				        <form action="updateintern.php" method="POST">
				            ...
				            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="intern_title" type="text" class="form-control" id="i_title" placeholder="" >
                                </div>
                                <div class="form-group">
                                    <label for="discrip"> Discrition</label>
                                    <input name="discription" type="text" class="form-control" id="discrip" placeholder="" >
                                </div>
					  ...
					  <div class="modal-dialog" role="document">
					    <div class="modal-content">
					      <div class="modal-header">
					        ...
					        <form action="deleteintern.php" method="POST">
